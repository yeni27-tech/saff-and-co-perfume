                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs" style="margin: 10px;">
                              <li class="nav-item" style="margin: 10px">
                                <a class="nav-link" href="#" data-target="#ostara" data-toggle="tab">
                                  <div class="judul">OSTARA</div>
                                  <div class="hoverimg">
                                  <img src="../img/OSTARA/OSTARA-01.d0603486.webp" width="330rem">
                                  </div>
                                  <img src="../img/OSTARA/Ostara.9e2a9284.webp" width="330rem">
                                  </a>
                                  <?php include '../php/postabpane10.php'; ?>
                              </li>
                              <li class="nav-item" style="margin: 10px">
                                <a class="nav-link" href="#" data-target="#mouse" data-toggle="tab">
                                  ...
                                  <?php include '../php/postabpane2.php'; ?>
                              </li>
                              <li class="nav-item" style="margin: 10px">
                                <a class="nav-link" href="#" data-target="#omnia" data-toggle="tab">
                                  ...
                                  <?php include '../php/postabpane9.php'; ?>
                              </li>
                            </ul>

                        <ul class="nav nav-tabs" style="margin: 10px;">
                              <li class="nav-item" style="margin: 10px">
                                <a class="nav-link" href="#" data-target="#trouple" data-toggle="tab">
                                  <div class="judul">TROUPE</div>
                                  <div class="hoverimg">
                                  <img src="../img/TROUPE/TROUPE-01.5885b973.webp" width="330rem">
                                  </div>
                                  <img src="../img/TROUPE/Troupe.d0bbcf37.webp" width="330rem">
                                  </a>
                                  <?php include '../php/postabpane14.php'; ?>
                              </li>
                        </ul>
                        </div>
                  </div>
