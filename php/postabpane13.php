            <!-- 13ST TAB -->
                        <div class="tab-pane fade in mt-2" id="solaris">
                                    ...
                                    <form method="post" action="./pos.php?action=add&id=<?php echo $product['PRODUCT_ID']; ?>">
                                     <div class="caracter13">
                                    <a class="border warm" href="#">Citrus</a>
                                    <a class="border woody" href="#">Floral</a>
                                    <a class="border aromatic" href="#">Woody</a>
                                    <a class="border b" href="#">Earthy</a>
                                    </div>       
                                    <div class="products">
                                            ...
                                            <input type="submit" name="addpos" class="btn btn-info"
                                                    value="Add" />
                                            <a href="../shop/SOLARIS/solaris.php">Description</a>        
                                                  </div>
                                        </div>
                                    </form>
                                    <?php endwhile;
