            <!-- 1ST TAB -->
                        <div class="tab-pane fade in mt-2" id="powersupply">
                                    ...
                                    <a class="border woody" href="#">Ambery</a>
                                    <a class="border aromatic" href="#">Gourmand</a>
                                    </div>    
                                    <div class="products">
                                            ...
                                            <input type="submit" name="addpos" class="btn btn-info"
                                                    value="Add" />
                                            <a href="../shop/MINOUET/minouet.php">Description</a>        
                                                  </div>
                                        </div>
                                    </form>
                                    <?php endwhile;
...
.caracter8 .woody {
  background-color: var(--ambery);
}

.caracter8 .aromatic {
  background-color: var(--gourmand) ;
}
