              <!-- 1ST TAB -->
                          <div class="tab-pane fade in mt-2" id="monitor">
                                    ...
                                    <a class="border warm" href="#">Enigmatic</a>
                                    <a class="border woody" href="#">Woody</a>
                                    <a class="border warm2" href="#">Warm Spicy</a>
                                    <a class="border aromatic" href="#">Creamy</a>
                                      ...
                                      <div class="products">
                                            ...
                                            <input type="submit" name="addpos" class="btn btn-info"
                                                    value="Add" />
                                            <a href="../shop/LAS_POZAS/las-pozas.php">Description</a>        
                                                  </div>
                                          </div>
                                      </form>
                                      <?php endwhile;
...
.character5 .warm {
  background-color: var(--enigmatic);
}
