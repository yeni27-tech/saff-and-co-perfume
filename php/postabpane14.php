            <!-- 14ST TAB -->
                        <div class="tab-pane fade in mt-2" id="trouple">
                                    ...
                                    <form method="post" action="./pos.php?action=add&id=<?php echo $product['PRODUCT_ID']; ?>">
                                     <div class="carakter14">
                                    <a class="border warm" href="#">Sweet</a>
                                    <a class="border woody" href="#">Rose</a>
                                    <a class="border aromatic" href="#">Fruity</a>
                                    </div>       
                                    <div class="products">
                                            ...
                                            <input type="submit" name="addpos" class="btn btn-info"
                                                    value="Add" />
                                            <a href="../shop/TOUPE/iliad.php">Description</a>        
                                                  </div>
                                        </div>
                                    </form>
                                    <?php endwhile;
