...
window.onload = function() {  
  ...
  // ------------------
  // penggunaan dasar dan metode tambahan
  // -------------------

  // ngembaliin semua provinsi
  console.log($.getProvinces());
  
  // ngembaliin smua kota
  console.log($.getAllCities());
  
  // akan mengembalikan semua kota di bawah provinsi tertentu (misal Cirebon)
