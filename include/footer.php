      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
              <span>©Wiyencka.id ofc (Yeni & Khalila)</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
...
//digunakan di nomor pos hanya pada kolom teks
...
//akhir digunakan di nomor pos hanya di bidang teks
</script>
